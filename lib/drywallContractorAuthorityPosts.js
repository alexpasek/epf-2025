...
function createPost(post) {
  ...
  if (post.slug === "drywall-contractor-basement-renovation-mississauga") {
    content.splice(3, 0, {
      html: `If your board is already installed, our ${link("/blog/basement-drywall-taping-mudding-mississauga/", "basement taping and mudding cost guide for Mississauga")} explains measured wall area, a 750 sq. ft. basement example, finish levels, and what to include in a finishing-only quote.`,
    });
  }
  const basementFinishingLinks = {
    "drywall-contractor-oakville-guide": {
      href: "/blog/basement-drywall-taping-mudding-oakville/",
      anchor: "Oakville basement taping and finish-selection guide",
      context: "For a bright recreation room, compare lighting, finish levels, and the primer handoff in our",
    },
    "drywall-contractor-burlington-guide": {
      href: "/blog/basement-drywall-taping-mudding-burlington/",
      anchor: "Burlington basement taping and phased-work guide",
      context: "If the household needs to keep using part of the basement, plan access, protection, and room boundaries with our",
    },
    "basement-drywall-contractor-hamilton": {
      href: "/blog/basement-drywall-taping-mudding-hamilton/",
      anchor: "Hamilton basement taping and contractor-handoff guide",
      context: "When another crew has already installed the board, separate corrections from normal finishing with our",
    },
  };
  const finishingLink = basementFinishingLinks[post.slug];
  if (finishingLink) {
    content.splice(3, 0, {
      html: `${finishingLink.context} ${link(finishingLink.href, finishingLink.anchor)}.`,
    });
  }
  return {
    title: post.title,
