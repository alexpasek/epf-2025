      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: "Etobicoke",
            item: { "@id": "https://epfproservices.com/popcorn-ceiling-removal/etobicoke/" },
          },
        ],
      },
    ],
  ...
  return (
    <div className="container-x mx-auto px-4 py-10">
        ...
        <div className="flex flex-col gap-4 md:grid md:grid-cols-[1fr,auto] md:items-start md:gap-6">
          <div>
            ...
            <p className="mt-3 text-sm text-gray-600">
              Need GTA-wide context? Explore our{" "}
              <Link
      ...
      <section id="neighborhoods" className="mt-10">
        <h2 className="text-2xl font-semibold">Popcorn Ceiling Removal Etobicoke — Neighbourhoods We Serve</h2>
