...
export const metadata = {
  title: `Baseboard Installation St. Catharines | Professional Baseboard Contractors`,
  description:
    "Professional baseboard installation in St. Catharines. Expert baseboard installation, baseboard replacement, shoe moulding. Licensed contractor. Free quotes, 3-year warranty.",
  keywords: [
    "baseboard installation st catharines",
    "baseboard replacement st catharines",
    "baseboard contractors st catharines",
  ...
  openGraph: {
    title: `Baseboard Installation St. Catharines | Professional Baseboard Contractors`,
    description:
      "Professional baseboard installation in St. Catharines. Expert baseboard installation, baseboard replacement, shoe moulding.",
...
function JsonLd() {
  const data = buildBaseboardCityGraph({
    ...
    description:
      "Professional baseboard installation in St. Catharines for trim replacement, shoe moulding, caulking, and paint-ready finishing in houses, condos, and renovation projects.",
    faqs: [
      {
...
export default function Page() {
  return (
    <div className="bg-gray-50">
      ...
      {/* HERO SECTION - UNIQUE TO ST. CATHARINES */}
            ...
            <div>
              <div className="inline-block mb-4 px-4 py-2 bg-blue-500/20 backdrop-blur-sm rounded-full border border-blue-400/30">
                <span className="text-sm font-semibold text-blue-300">
                  🏆 St. Catharines' #1 Baseboard Contractor
                </span>
              </div>

              <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                Professional Baseboard Installation in St. Catharines
              </h1>

              <p className="text-xl text-gray-200 mb-6 leading-relaxed">
                Need baseboards installed after new flooring or a renovation in
                St. Catharines? We handle new installs, replacements, and shoe
                moulding for condos, townhomes, and detached homes across Port
                Dalhousie, Old Glenridge, Merritton, and the North End.
              </p>
              <p className="text-lg text-gray-200 mb-6 leading-relaxed">
                Expect tight coped corners, clean returns, and a paint-ready
                finish. We match existing profiles in older St. Catharines homes
                and recommend moisture-resistant materials for basements or
                lakeside properties.
              </p>
              ...
              <div className="mt-8 grid grid-cols-3 gap-4">
                <div className="text-center">
                  <div className="text-3xl font-bold text-cyan-300">400+</div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <p className="text-gray-600 mb-6">
                  Professional baseboard installation in St. Catharines — Fast
                ...
                <div className="mt-6 pt-6 border-t border-gray-200 text-center">
                  <p className="text-sm text-gray-600 mb-2">
                    Serving all St. Catharines neighborhoods:
                  </p>
                  <p className="text-xs text-gray-500">
                    Port Dalhousie • Old Glenridge • Merritton • North End •
                    Western Hill • Grantham
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                Baseboard Installation Services in St. Catharines
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Complete baseboard solutions for St. Catharines homes and
                lakeside properties
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: "6-8 inch profiles for modern builds and higher ceilings common in newer St. Catharines neighborhoods.",
                  features: [
                    "6-8 inch profiles",
                    "Modern styles",
                    "High ceilings",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-4">
              Our St. Catharines Baseboard Installation Process
            </h2>
            <p className="text-center text-lg text-gray-600 mb-16 max-w-3xl mx-auto">
              Professional workflow delivering perfect baseboards for St.
              Catharines homes
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-4">
              St. Catharines Baseboard Installation Pricing
            </h2>
            <p className="text-center text-lg text-gray-600 mb-12 max-w-3xl mx-auto">
              Transparent pricing for St. Catharines homes and lakefront
              properties
            </p>
              ...
              <table className="w-full bg-white rounded-2xl shadow-xl border-2 border-gray-200">
                ...
                <tbody className="divide-y divide-gray-200">
                  ...
                  <tr className="hover:bg-blue-50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-gray-700">
                      Ideal for St. Catharines lakeside homes
                    </td>
                  </tr>
                  <tr className="hover:bg-blue-50 transition-colors">
                    <td className="px-6 py-4 font-semibold text-gray-900">
            ...
            <div className="mt-8 p-6 bg-blue-50 border-2 border-blue-200 rounded-2xl">
              <h3 className="text-xl font-bold mb-3 text-gray-900">
                💡 St. Catharines Pricing Examples:
              </h3>
              <ul className="space-y-2 text-gray-700">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 mt-1">→</span>
                  <span>
                    Full St. Catharines home (2000 sq ft): $3200-6000 turnkey
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 mt-1">→</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-6">
              Why St. Catharines Homeowners Choose Us for Baseboard Installation
            </h2>
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              St. Catharines homes range from heritage properties near St. Paul
              Street to newer builds in the North End and Merritton, plus
              lakeside homes near Port Dalhousie. Each needs the right profile,
      ...
      {/* ST. CATHARINES NEIGHBORHOODS */}
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-4">
              Baseboard Installation St. Catharines — Neighbourhoods We Serve
            </h2>
            <p className="text-center text-lg text-gray-600 mb-12 max-w-3xl mx-auto">
              Professional baseboard installation in every St. Catharines
              neighborhood
            </p>
      ...
      {/* ST. CATHARINES LOCAL SEO CONTENT */}
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="prose prose-lg max-w-none">
              <h2 className="text-4xl font-bold mb-6">
                St. Catharines baseboard installation with clear scope and local
                fit
              </h2>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                ...
                paint-ready finish that suits St. Catharines homes. We work in
                condos near Downtown, townhomes in the North End, and detached
                homes in Old Glenridge, Merritton, and Port Dalhousie.
              </p>
              ...
              <h3 className="text-2xl font-bold mb-4 mt-8">
                Material choice for St. Catharines homes
              </h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                Most St. Catharines projects price by linear foot, typically
                $8-15/ft depending on profile height, material, wall conditions,
                and whether painting is included. Share room sizes and a few
                photos for a written quote.
              </p>
              ...
              <div className="bg-blue-50 border-2 border-blue-200 rounded-2xl p-6 my-8">
                <h4 className="text-xl font-bold mb-4">
                  Common St. Catharines requests we handle
                </h4>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">✓</span>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                Many St. Catharines clients combine baseboard work with{" "}
                <Link
                ...
                for a clean, finished look without reworking trim after other
                trades are complete.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <a
                  href="https://www.stcatharines.ca/en/building-and-development/building-permits.aspx"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-600 font-semibold hover:underline"
                >
                  City of St. Catharines Building Department
                </a>
                .
              </p>
              ...
              <div className="bg-gradient-to-br from-blue-600 to-cyan-600 text-white rounded-3xl p-8 my-8 text-center">
                <h3 className="text-2xl font-bold mb-4">
                  Ready for a St. Catharines baseboard quote?
                </h3>
                <p className="text-blue-100 mb-6 text-lg">
                  Same-day estimates for lakefront and family homes across the
      ...
      <section id="faqs" className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-12">
            Baseboard Installation FAQ - St. Catharines
          </h2>

          <div className="space-y-4">
            {[
              {
                q: "What does baseboard installation cost in St. Catharines?",
              ...
              {
                q: "Which material should I choose for my St. Catharines home?",
              ...
              {
                q: "Do you work in St. Catharines condo buildings?",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Ready for Professional Baseboard Installation in St. Catharines?
            </h2>
            <p className="text-2xl mb-8 text-blue-100">
              Your trusted St. Catharines baseboard contractor for lakefront and
              family homes
            </p>
