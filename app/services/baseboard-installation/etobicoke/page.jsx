...
const CITY_NAME = "Etobicoke";
const CITY_SLUG = "etobicoke";
...
export const metadata = {
  title: `Baseboard Installation Etobicoke | Professional Baseboard Contractors`,
  description:
    "Professional baseboard installation in Etobicoke. Expert baseboard installation, baseboard replacement, shoe moulding. Licensed contractor. Free quotes, 3-year warranty.",
  keywords: [
    "baseboard installation etobicoke",
    "baseboard replacement etobicoke",
    "baseboard contractors etobicoke",
  ...
  openGraph: {
    title: `Baseboard Installation Etobicoke | Professional Baseboard Contractors`,
    description:
      "Professional baseboard installation in Etobicoke. Expert baseboard installation, baseboard replacement, shoe moulding.",
    url: SERVICE_URL,
    type: "website",
  },
...
export default function Page() {
  return (
    <div className="bg-gray-50">
      ...
      {/* HERO SECTION - UNIQUE TO ETOBICOKE */}
            ...
            <div>
              <div className="inline-block mb-4 px-4 py-2 bg-blue-500/20 backdrop-blur-sm rounded-full border border-blue-400/30">
                <span className="text-sm font-semibold text-blue-300">
                  🏆 Etobicoke's #1 Baseboard Contractor
                </span>
              </div>

              <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                Professional Baseboard Installation in Etobicoke
              </h1>

              <p className="text-xl text-gray-200 mb-6 leading-relaxed">
                Looking for expert baseboard installation in Etobicoke? Our
                ...
                Etobicoke's diverse neighborhoods—from Mimico to Long Branch,
                Kingsway to Islington, Humber Bay to Rexdale.
              </p>
              <p className="text-lg text-gray-200 mb-6 leading-relaxed">
                With over 900 completed baseboard projects across Etobicoke, we
                deliver precise craftsmanship including coped corners, tight miter
                joints, seamless caulking, and paint-ready finishing that
                transforms your West Toronto space.
              </p>
              ...
              <div className="mt-8 grid grid-cols-3 gap-4">
                <div className="text-center">
                  <div className="text-3xl font-bold text-cyan-300">900+</div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <p className="text-gray-600 mb-6">
                  Professional baseboard installation in Etobicoke — Fast response,
                  transparent pricing
                </p>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200 text-center">
                  <p className="text-sm text-gray-600 mb-2">
                    Serving all Etobicoke neighborhoods:
                  </p>
                  <p className="text-xs text-gray-500">
                    Mimico • Long Branch • Kingsway • Islington • Humber Bay •
                    Rexdale
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                Baseboard Installation Services in Etobicoke
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Complete baseboard solutions for Etobicoke homes, condos, and lakefront properties
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Professional installation of brand new baseboards throughout Etobicoke. We work with MDF, hardwood, and PVC profiles with perfect coped inside corners.",
                  features: ["MDF & hardwood", "All profiles", "Coped corners"],
                },
                {
                  icon: "🔄",
                  title: "Baseboard Replacement",
                  desc: "Complete removal of old damaged baseboards in Etobicoke homes and installation of new trim with proper wall prep.",
                  features: [
                    "Old trim removal",
                    "Wall repair",
                    "New installation",
                ...
                },
                {
                  icon: "👞",
                  title: "Shoe Moulding",
                  desc: "Add shoe moulding or quarter round to Etobicoke homes to complement baseboards and cover floor expansion gaps.",
                  features: [
                    "Shoe moulding",
                    "Quarter round",
                    "Floor transitions",
                ...
                },
                {
                  ...
                  desc: "Modern tall baseboards (6-8 inches) installation for contemporary Etobicoke homes with high ceilings.",
                  features: [
                    "6-8 inch profiles",
                    "Modern styles",
                    "High ceilings",
                ...
                },
                {
                  ...
                  desc: "Professional caulking of all seams for Etobicoke projects, nail hole filling, and smooth sanding for paint-ready finish.",
                  features: ["Seamless caulk", "Hole filling", "Paint-ready"],
                },
                {
                  icon: "🎨",
                  title: "Painting & Staining",
                  desc: "Complete priming and painting service for Etobicoke baseboard projects or staining for wood baseboards.",
                  features: [
                    "Primer & paint",
                    "Wood staining",
                    "Color matching",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-4">
              Our Etobicoke Baseboard Installation Process
            </h2>
            <p className="text-center text-lg text-gray-600 mb-16 max-w-3xl mx-auto">
              Professional workflow delivering perfect baseboards for Etobicoke homes
            </p>
              ...
              {[
                {
                  ...
                  desc: "Precise measurements and profile selection for your Etobicoke home. We account for wall irregularities, corner angles, and transition points specific to West Toronto properties.",
                },
                {
                  step: "2",
                  title: "Remove Existing Trim",
                  desc: "Careful removal of old baseboards, shoe moulding, and quarter round without damaging drywall in your Etobicoke property. All debris is hauled away.",
                },
                {
                  step: "3",
                  title: "Wall Preparation",
                  desc: "Level check, fill gaps, and prep surfaces for perfect baseboard adhesion and alignment throughout your Etobicoke home.",
                },
                {
                  step: "4",
                ...
                },
                {
                  ...
                  desc: "Fill nail holes, caulk top edge and shoe mould, sand smooth for paint-ready finish across your Etobicoke property.",
                },
                {
                  step: "6",
                  title: "Paint & Final Inspection",
                  desc: "Optional primer and finish coat. Final quality check ensuring tight seams and clean lines throughout your Etobicoke home.",
                },
              ].map((item) => (
                <div
                  key={item.step}
