...
export const metadata = {
  title: `Baseboard Installation Hamilton | Professional Baseboard Contractors`,
  description:
    "Professional baseboard installation in Hamilton. Expert baseboard installation, baseboard replacement, shoe moulding. Licensed contractor. Free quotes, 3-year warranty.",
  keywords: [
    "baseboard installation hamilton",
    "baseboard replacement hamilton",
    "baseboard contractors hamilton",
  ...
  openGraph: {
    title: `Baseboard Installation Hamilton | Professional Baseboard Contractors`,
    description:
      "Professional baseboard installation in Hamilton. Expert baseboard installation, baseboard replacement, shoe moulding.",
    url: SERVICE_URL,
    type: "website",
  },
...
export default function Page() {
  return (
    <div className="bg-gray-50">
      ...
      {/* HERO SECTION - UNIQUE TO HAMILTON */}
            ...
            <div>
              <div className="inline-block mb-4 px-4 py-2 bg-blue-500/20 backdrop-blur-sm rounded-full border border-blue-400/30">
                <span className="text-sm font-semibold text-blue-300">
                  🏆 Hamilton's #1 Baseboard Contractor
                </span>
              </div>

              <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                Professional Baseboard Installation in Hamilton
              </h1>

              <p className="text-xl text-gray-200 mb-6 leading-relaxed">
                Looking for expert baseboard installation in Hamilton? Our
                ...
                Hamilton's diverse neighborhoods—from Downtown to the Mountain,
                Durand to Dundas, Ancaster to Stoney Creek.
              </p>
              <p className="text-lg text-gray-200 mb-6 leading-relaxed">
                With over 650 completed baseboard projects across Hamilton, we
                deliver precise craftsmanship including coped corners, tight
                miter joints, seamless caulking, and paint-ready finishing for
                both character homes and modern properties.
              </p>
              ...
              <div className="mt-8 grid grid-cols-3 gap-4">
                <div className="text-center">
                  <div className="text-3xl font-bold text-cyan-300">650+</div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <p className="text-gray-600 mb-6">
                  Professional baseboard installation in Hamilton — Fast
                ...
                <div className="mt-6 pt-6 border-t border-gray-200 text-center">
                  <p className="text-sm text-gray-600 mb-2">
                    Serving all Hamilton neighborhoods:
                  </p>
                  <p className="text-xs text-gray-500">
                    Mountain • Downtown • Durand • Dundas • Ancaster • Stoney
                    Creek
                  </p>
                </div>
              </div>
