        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-10">
              <p className="text-sm uppercase tracking-widest text-blue-600 font-bold mb-3">
                MILTON REPAIR GUIDES
              </p>
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                Plan Your Milton Drywall Repair
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                These guides help Milton homeowners understand basement repairs,
                trade cutouts, ceiling cracks, new-build patching, and when
                replacement is smarter than patching.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ["/blog/basement-drywall-repair-milton/", "Basement Drywall Repair Milton", "Milton basement leaks, plumbing access holes, ceiling patches, and paint-ready finishing."],
                ["/blog/drywall-repair-after-plumbing-electrical-work/", "Plumbing & Electrical Cutouts", "Patch or access panel decisions after trades open walls and ceilings."],
                ["/blog/ceiling-crack-drywall-repair/", "Ceiling Crack Repair", "Why cracks return after painting and how proper drywall repair fixes the source."],
                ["/blog/drywall-repair-vs-replacement/", "Repair vs Replacement", "How to decide between a patch, cut-out replacement, or broader refinishing."],
              ].map(([href, title, desc]) => (
                <Link
                  key={href}
                  href={href}
