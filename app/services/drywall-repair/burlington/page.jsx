            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              <div className="max-w-3xl">
                ...
                <p className="mt-4 text-lg text-slate-700">
                  If your walls crack in winter, bubble in humid weather, or
                  keep reopening in the same places, read our Burlington guide
                  on what keeps causing those drywall problems and when a real
                  repair is worth doing.
                </p>
              </div>
              <Link
                href="/blog/how-seasonal-humidity-and-temperature-changes-affect-drywall-burlington/"
