        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-10">
              <p className="text-sm uppercase tracking-widest text-blue-600 font-bold mb-3">
                HAMILTON REPAIR GUIDES
              </p>
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                Plan Your Hamilton Drywall Repair
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Use these guides to compare basement repairs, plumbing cutouts,
                ceiling cracks, water damage, and repair-versus-replacement
                decisions before booking.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                ["/blog/drywall-repair-vs-replacement/", "Repair vs Replacement", "When to patch, cut out damaged drywall, or replace a wider section."],
              ].map(([href, title, desc]) => (
                <Link
                  key={href}
                  href={href}
