...
export const metadata = {
  ...
  alternates: { canonical: "/service-areas/popcorn-ceiling-removal/toronto/" },
  openGraph: {
    ...
    url: "/service-areas/popcorn-ceiling-removal/toronto/",
    type: "article",
  },
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: "Toronto",
            item: "/service-areas/popcorn-ceiling-removal/toronto/",
          },
        ],
      },
    ],
      ...
      <section id="neighborhoods" className="mt-10">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {hoods.map((n) => (
            <Link
              key={n.slug}
              href={`/service-areas/popcorn-ceiling-removal/toronto/${n.slug}/`}
              className="pill"
            >
              {n.name}
            </Link>
