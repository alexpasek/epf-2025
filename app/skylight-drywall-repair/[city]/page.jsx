...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    keywords: [
      ...
      `cathedral ceiling repair ${city.city}`,
      `cathedral ceiling repair around skylight ${city.city}`,
      `vaulted ceiling repair around skylight ${city.city}`,
      `skylight tunnel drywall repair ${city.city}`,
      `skylight water damage repair ${city.city}`,
      `ceiling water damage around skylight ${city.city}`,
      `ceiling repair around skylight ${city.city}`,
      `ceiling stain from skylight leak ${city.city}`,
      `popcorn ceiling removal around skylight ${city.city}`,
      `cathedral ceiling popcorn removal ${city.city}`,
      `stipple removal around skylight ${city.city}`,
      `remove popcorn ceiling around skylight ${city.city}`,
      `smooth ceiling around skylight ${city.city}`,
      `ceiling painting after skylight repair ${city.city}`,
      `painting cathedral ceiling around skylight ${city.city}`,
    ],
