export const skylightRepairCities = [
  {
    city: "Hamilton",
    slug: "hamilton",
    title: "Skylight Drywall Repair Hamilton | Ceiling Damage & Popcorn Removal",
    metaDescription:
      "Drywall repair around skylights in Hamilton. EPF repairs skylight ceiling damage, water stains, cracked drywall, shafts, and popcorn texture.",
  ...
  },
  {
    ...
    metaDescription:
      "Burlington skylight drywall repair, ceiling water damage repair, skylight shaft refinishing, and popcorn ceiling removal around skylights.",
  ...
  },
  {
    ...
    metaDescription:
      "Oakville drywall repair around skylights, skylight shaft repair, ceiling water damage repair, and smooth ceiling finishing around skylight openings.",
  ...
  },
  {
    ...
    metaDescription:
      "Mississauga skylight drywall repair, ceiling water damage repair, popcorn ceiling removal around skylights, and skylight shaft refinishing.",
...
export const skylightRepairImagePrompts = {
  hub:
    "Realistic professional photo of an Ontario home interior with a visible ceiling skylight/light well, protected floor and furniture, drywall skim coat repair around the skylight shaft, minor water-stain repair preparation, clean contractor tools, natural daylight through the skylight. No text, logos, watermarks, exterior roof work, skylight replacement, or faces.",
  hamilton:
...
export const skylightRepairCityMap = new Map(
  skylightRepairCities.map((city) => [city.slug, city])
);
